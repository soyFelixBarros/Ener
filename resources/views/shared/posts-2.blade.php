	...
	<div class="card-columns">
		...
		<div class="card">
			...
			<div class="card-body">
				...
				@endif
				<p class="card-text"><small><a href="{{ route('newspaper_show', ['newspaper' => $post->newspaper->slug]) }}" class="text-muted">{{ $post->newspaper->name }}</a> - <time class="timeago text-muted" datetime="{{ $post->created_at }}" title="{{ $post->created_at }}"></time></small></p>
			</div><!-- .card-body -->
		</div><!-- .card -->
		@endforeach
	</div><!-- .card-columns -->
