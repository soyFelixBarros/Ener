	...
	<section class="row">
		...
		<article class="card mb-4">
			<div class="card-body">
				...
				<img src="https://www.google.com/s2/favicons?domain={{ $newspaper->host }}" style="margin-top: -5px;" width="16" height="16"/> <a href="{{ $newspaper->website }}" class="text-dark" target="_blank">{{ $newspaper->host }}</a>
