    ...
    <article class="col-xs-12 col-sm-12 col-md-12 col-lg-6 clearfix item">
        <div class="row">
            ...
            <div class="col-xs-4 col-sm-5 col-md-3 col-lg-4 image">
                <a href="{{ $post->url }}" target="_blank" rel="bookmark"><img src="/images/{{ $post->image }}?w=170&h=150&fit=crop-top&sharp=10" width="170" height="150" class="img-responsive" alt="{{ $post->title }}"></a>
            </div>
